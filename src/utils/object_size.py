...
class MeasureObject:
    ...
    def detect_edges(self):
        edged = cv2.Canny(self.blurred_image, 50, 100)
    ...
    def find_contours(self):
        ...
        (image_contours, _) = contours.sort_contours(image_contours)
        ...
        while True:
            ...
            for contour in self.image_contours:
                ...
                cv2.line(orig, (int(top_left_top_right_x), int(top_left_top_right_y)), (int(bottom_left_bottom_right_x),
                         ...
                         (255, 0, 255), 2)
                cv2.line(orig, (int(top_left_bottom_left_x), int(top_left_bottom_left_y)),
                         (int(top_right_bottom_right_x),
                ...
                cv2.putText(orig, "{:.1f}cm".format(dimension_a),
                            (int(top_left_top_right_x - 15), int(top_left_top_right_y - 10)), cv2.FONT_HERSHEY_SIMPLEX,
                            0.65, (255, 255, 255), 2)
                cv2.putText(orig, "{:.1f}cm".format(dimension_b),
                            (int(top_right_bottom_right_x + 10), int(top_right_bottom_right_y)),
